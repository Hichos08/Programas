...
$precio_compra = mysqli_real_escape_string($connect, $_POST["precio_compra"]); 
$peso_libras = mysqli_real_escape_string($connect, $_POST["peso_libras"]); 
...
date_default_timezone_set('America/Guatemala');
        ...
        $insertar = ("INSERT INTO registro_lechones (precio_compra,peso_libras,descripcion, edad, estado, fecha) values ('$precio_compra','$peso_libras','$descripcion','$edad','$estado','$b')");
...
<h3 class="pb-3">Registro y Compra de Lechones</h3>
<div class="form-style">
<form method="POST" enctype="multipart/form-data">
  <div class="form-group pb-3">    
    <input type="text" placeholder="Precio Compra" class="form-control" id="precio_compra" name="precio_compra">   
  </div>
  <div class="form-group pb-3">    
  ...
  <div class="form-group pb-3">    
    <input type="text" placeholder="Edad" class="form-control" id="edad" name="edad">   
  </div>
 <div class="form-group pb-3">    
   <select class="form-control" name="estado">
          <option value="" selected="selected">  selecccionar Estado  </option>
