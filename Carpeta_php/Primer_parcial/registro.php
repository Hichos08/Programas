...
//	}
	...
	{	
		try
		{	
			$select_stmt=$db->prepare("SELECT username FROM mainlogin WHERE username=:uname"); // consulta sql
			...
			{
				$insert_stmt=$db->prepare("INSERT INTO mainlogin(username,password,role) VALUES(:uname,:upassword,:urole)"); //Consulta sql de insertar			
				$insert_stmt->bindParam(":uname",$username);	 		//parámetros de enlace 
