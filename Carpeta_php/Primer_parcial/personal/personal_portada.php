...
date_default_timezone_set('America/Guatemala');
 ...
 $insertar = ("INSERT INTO regitro_peso (cod_animal,peso_libras,fecha) values ('$cod_animal','$peso_libras','$b')");
 $actualizar = ("UPDATE registro_lechones  SET peso_libras='$peso_libras',fecha='$b' where cod_animal = '$cod_animal'");
