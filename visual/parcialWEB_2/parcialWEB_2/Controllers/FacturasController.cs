...
namespace parcialWEB_2.Controllers
{
    public class FacturasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdFactura,Fecha,IdCliente")] Factura factura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdFactura,Fecha,IdCliente")] Factura factura)
        {
            if (ModelState.IsValid)
            {
